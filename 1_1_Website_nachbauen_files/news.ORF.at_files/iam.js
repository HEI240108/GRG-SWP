  ...
  for (var i = 0, iLen = iomnames.length; i < iLen; i += 1) {
    global[iomnames[i]] = (function () {
      var dummySite = "dummy",
        ...
        cookieName = "ioam2018",
        cookieMaxRuns = 0,
        socioToken = "47c65252524dc6c149783ed97b0bcce7",
      ...
      var fpCookieDomain = getFpcd(location.hostname),
        consentVendors = ('[730]'.match(/[0-9]+/g) || []).map(function (vendor) { return parseInt(vendor, 10) }),
      ...
      function buildResult(params) {
        ...
        result.lo = "AT/Vienna";
        result.cb = "0001";
        result.i2 = "0001a9a43106ea9ec65252524";
        result.ep = parseInt('1724823585', 10);
        result.vr = "423";
